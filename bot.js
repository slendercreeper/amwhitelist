...
const Settings = {
  //THIS IS IMPORTANT\\
  GUILD_ID: "917973177479618561", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR SERVER, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  OWNER_ID: "779390731441012766", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR PROFILE, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  Shoppy_API_KEY: "pHDumbTrMyso9SckZjcqmnoXFSsuro40TDIVn7HHf3KepEpttI", // Create a Shoppy account If you haven't, then go to https://shoppy.gg/user/settings and look for your "API-KEY".
  Whitelisted_Role_ID: "946893767997280297", // When users use the !whitelist or !rewhitelist command, they get this role.
  Blacklisted_Role_ID: "927036411473973268", // When users who are not whitelist use the !rewhitelist command with a buyers Shoppy Order ID, they get this role.
  LogsChannel_Channel_ID: "917973940670967868", // Create a channel for logs when a user is whtelisted or uses a command!
  //----------------\\
   ...
   .then(function (res) { 
     ...
     else
     {
       if (res.data["confirmations"] === 1 && res.data["product"]["confirmations"]) {
         ...
         message.reply("_G.Key = '"+key+"'\nloadstring(game:HttpGet('https://am-whitelist.herokuapp.com/script.lua', true))()") // Change PROJECTNAME to the project u made on heroku!!!
